            ...
            <div class="text__container d-flex justify-between">
                <div class="progress-bar d-flex justify-between align-item-center mb-2">
                    ...
                    <div class="d-flex justify-center align-item-center">
                        ...
                        <h3 class="ml-10" style="color: #fffffd;">預覽文章</h3>
                    </div>
                    <svg width="9" height="15" viewBox="0 0 9 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_1427_26206)">
                            <path d="M1.2498 15.001C0.929961 15.001 0.609961 14.8789 0.366211 14.6348C-0.12207 14.1465 -0.12207 13.3555 0.366211 12.8672L5.73418 7.50097L0.366211 2.13379C-0.12207 1.64551 -0.12207 0.854492 0.366211 0.366211C0.854492 -0.12207 1.64551 -0.12207 2.13379 0.366211L8.38379 6.61621C8.87207 7.10449 8.87207 7.8955 8.38379 8.38379L2.13379 14.6338C1.88965 14.8799 1.56973 15.001 1.2498 15.001Z" fill="#fff" />
                    ...
                    <div class="d-flex justify-center align-item-center">
                        ...
                        <h3 class="ml-10" style="color: #10FFA2">發布文章</h3>
                    </div>
                </div>
                <div class="finish d-flex flex-col justify-center align-item-center mt-30" style="height: 40vh;">
                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M40 20C40 25.3043 37.8929 30.3914 34.1421 34.1421C30.3914 37.8929 25.3043 40 20 40C14.6957 40 9.60859 37.8929 5.85786 34.1421C2.10714 30.3914 0 25.3043 0 20C0 14.6957 2.10714 9.60859 5.85786 5.85786C9.60859 2.10714 14.6957 0 20 0C25.3043 0 30.3914 2.10714 34.1421 5.85786C37.8929 9.60859 40 14.6957 40 20ZM30.075 12.425C29.8964 12.247 29.6838 12.1069 29.4498 12.013C29.2159 11.9191 28.9654 11.8734 28.7133 11.8785C28.4613 11.8837 28.2128 11.9396 27.9829 12.0429C27.7529 12.1463 27.5462 12.2949 27.375 12.48L18.6925 23.5425L13.46 18.3075C13.1046 17.9763 12.6344 17.796 12.1487 17.8046C11.6629 17.8131 11.1995 18.0099 10.8559 18.3534C10.5124 18.697 10.3156 19.1604 10.3071 19.6462C10.2985 20.1319 10.4788 20.6021 10.81 20.9575L17.425 27.575C17.6032 27.7529 17.8154 27.893 18.049 27.9871C18.2825 28.0812 18.5326 28.1273 18.7844 28.1226C19.0361 28.118 19.2843 28.0627 19.5142 27.96C19.7441 27.8573 19.951 27.7094 20.1225 27.525L30.1025 15.05C30.4427 14.6962 30.6307 14.2232 30.626 13.7324C30.6213 13.2416 30.4244 12.7722 30.0775 12.425H30.075Z" fill="#10FFA2" />
                    </svg>
                    <h3 class="mt-30">您的文章已發布完成!</h3>
                    <!-- <h3 class="mt-20">三秒後將跳轉到文章頁面</h3> -->
                </div>
                <div class="btn-bottom w-100 d-flex justify-center">
                    <button class="btn_4w btn-preview mt-10" onclick="gobackforum()">文章首頁</button>
                </div>
            </div>
